    ...
    public static class ServiceSwagger
    {
        public static IServiceCollection AddServiceSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc(Constants.Catalogs, new OpenApiInfo
                {
                    Version = Constants.ServiceVersion,
                    Title = Constants.CatalogsTitle
                });
  
                c.SwaggerDoc(Constants.Reports, new OpenApiInfo
                {
                    Version = Constants.ServiceVersion,
                    Title = Constants.ReportesTitle
                });
                
                c.SwaggerDoc(Constants.Principals, new OpenApiInfo
                {
                    Version = Constants.ServiceVersion,
                    Title = Constants.PrincipalTitle
                });
