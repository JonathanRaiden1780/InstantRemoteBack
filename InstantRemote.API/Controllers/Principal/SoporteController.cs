...
namespace InstantRemote.Api.Controllers.Principal
{
    ...
    public class SoporteController : BaseController
    {
        ...
        [HttpGet(Constants.GetAltasMan)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetAltasMan()
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetAltasMan();
                result = Ok(response);
            }
        ...
        [HttpGet(Constants.GetBitComMan)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetBitComMan(string fechaIni, string fechaFin)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetBitComMan(fechaIni,fechaFin);
                result = Ok(response);
            }
        ...
        [HttpGet(Constants.GetTipoTel)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetTipoTel(string numTelefonico)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetTipoTel(numTelefonico);
                result = Ok(response);
            }
        ...
        [HttpGet(Constants.GetPantallas)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetPantallas()
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetPantallas();
                result = Ok(response);
            }
        ...
        [HttpGet(Constants.GetPantAccion)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetPantAccion(string pantalla)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetPantAccion(pantalla);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetBitacora)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetBitacora([FromBody]req.GetBitacoraReq req)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceSoporte.GetBitacora(req);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.Reprocess)]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult Repocess([FromBody]req.Reprocess req)
        {
            ActionResult result;
            try
            {
                serviceFactory("IR").ServiceSoporte.Reprocess(req);
                result = Ok();
            }
