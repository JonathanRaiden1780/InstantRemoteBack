...
namespace InstantRemote.Api.Controllers.Reports
{
    ...
    public class ReportsController : BaseController
    {
        ...
        [HttpPost(Constants.GetReportAsistenciaTemperaturaAll)]
        [ProducesResponseType(typeof(List<res.GetReportAsistenciaTempAll>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportAsistenciaTemperaturaAll([FromBody] FiltroAsistencia filtro)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportAsistenciaTemperaturaAll(filtro);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportAsignaciones)]
        [ProducesResponseType(typeof(List<res.GetReportAsignaciones>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportAsignaciones([FromBody] string numEmpleado)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportAsignaciones(numEmpleado);
                result = Ok(response);
            }
        ...
        [HttpGet(Constants.GetReportAsignacionesAll)]
        [ProducesResponseType(typeof(List<res.GetReportAsignaciones>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportAsignacionesAll()
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportAsignacionesAll();
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportMatrizApro)]
        [ProducesResponseType(typeof(List<res.GetReportMatriz>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportMatrizApro([FromBody] FiltroMatriz filtro)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportMatrizApro(filtro);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportCapturaManual)]
        [ProducesResponseType(typeof(List<res.GetReportCapturaManual>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportCapturaManual([FromBody] string year)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportCapturaManual(year);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportAusenOmision)]
        [ProducesResponseType(typeof(List<res.GetReportAusenOmis>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportAusenOmision([FromBody] FiltroAsistenciaAnualResumen filtro)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportAusenOmision(filtro);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportHrsExtrasComp)]
        [ProducesResponseType(typeof(List<res.GetReportesHrsExtrasComp>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportHrsExtrasComp([FromBody] FiltroHrsExtra filtro)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportHrsExtrasComp(filtro);
                result = Ok(response);
            }
        ...
        [HttpPost(Constants.GetReportHrsExtrasNoProcs)]
        [ProducesResponseType(typeof(List<res.GetReportesHrsExtrasNoProc>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(BadRequestDto), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(res.FunctionalErrorMessageDto), StatusCodes.Status409Conflict)]
        [ProducesResponseType(typeof(res.CriticalErrorMessageDto), StatusCodes.Status500InternalServerError)]
        public ActionResult GetReportHrsExtrasNoProcs([FromBody] FiltroHrsExtra filtro)
        {
            ActionResult result;
            try
            {
                var response = serviceFactory("IR").ServiceReports.GetReportHrsExtrasNoProcs(filtro);
                result = Ok(response);
            }
